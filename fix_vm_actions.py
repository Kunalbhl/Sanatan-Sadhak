...
replacement = """    fun upvoteComment(comment: com.example.data.PostComment) {
...
if "upvoteComment" not in text:
    text = text.replace("    fun deletePostComment(id: Int) {", replacement + "\n    fun deletePostComment(id: Int) {")
